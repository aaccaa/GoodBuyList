...
public class ProductListActivity extends Activity {
	...
	private class DownloadTask extends AsyncTask<String, Void, SimpleAdapter> {
		...
		ProgressDialog progDailog = new ProgressDialog(ProductListActivity.this);
		...
		protected SimpleAdapter doInBackground(String... url) {
			try {
				...
				products = HtmlParseUtil.ParseProductHtml(data);
				Log.e("tag", "done parsing" + products.size());
			} catch (Exception e) {
				Log.d("Background Task", e.toString());
			}

			String[] from = { "pic", "itemname", "Price", "List Price" };
			int[] to = { R.id.iv_pic, R.id.tv_product_details1,
					R.id.tv_product_details2, R.id.tv_product_details3 };
...
/*
			OnItemClickListener mMessageClickedHandler = new OnItemClickListener() {
				public void onItemClick(AdapterView parent, View v,
					...
					HashMap<String, Object> temp = (HashMap<String, Object>) parent
